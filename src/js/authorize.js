...
import { createUserWithEmailAndPassword , signInWithEmailAndPassword , signOut , GoogleAuthProvider , signInWithPopup , sendPasswordResetEmail , onAuthStateChanged , updateProfile } from "firebase/auth";
...
export function Authorize(){
    ...
    const registerUser = async(fullname,email,password)=>{
        ...
        const defaultprofileimg = "https://static.thenounproject.com/png/2014807-200.png";
